          ...
          ">
            ...
            {projects.map((project, index) => (
              <div
                ...
                ${
                  index === activeIndex
                    ? "on min-w-auto bg-tw-black hover:bg-tw-black hover:text-tw-white text-tw-white"
                    : "text-tw-grey"
                }
                ${
                  index !== activeIndex
                    ? "[&_.year]:hidden [&_.media]:hidden"
                    : ""
                }
                ...
                <div className="info text-xs h-[calc(100%-2.6vw)] w-auto m-[1.3vw_3.3vw_0_0] flex flex-col gap-4 max-w-[340px] w-[300px] overflow-hidden p-3">
                  ...
                  {project.services && (
                    <div className="info_block w-[300px]">
                      ...
                      <h2 className="content max-w-[300px] whitespace-normal">
                        {project.services}
                      </h2>
                    </div>
                  )}
              ...
              >
                {isMobile && !project.useH1 && (
                  <div className="justify-between items-center mb-4 hidden">
                    <h3 className="font-object-bold text-lg">
                      {project.label}
                    </h3>
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <div className="info text-xs flex flex-col gap-2">
                    ...
                    {project.services && (
                      <div className="info_block">
                        <div className="label">Services</div>
                        <h2 className="content whitespace-normal">
                          {project.services}
                        </h2>
                      </div>
                    )}
