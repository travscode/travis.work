export const projects = [
  {
    ...
    other:
      "For the past 20 years or so, I've been designing and building digital things — apps for startups, tools for record labels, and the occasional bigger project for teams like Google and the UN. Along the way, some of the work's been featured by Apple and recognised by a few industry awards, which has been nice. I've also had the chance to work with agencies like VML and Wunderman Thompson, helping brands such as Wendy's, KitKat, HBF and Heinz turn ideas into things people can actually use.<br /><br />I'm most comfortable working in the grey areas — the early, messy stages where things aren't fully defined yet. I'm less interested in titles and more interested in doing meaningful work with good people, especially when there's a bigger purpose behind it. I tend to gravitate toward roles where I can help connect ideas, people, and momentum.<br /><br />If you've got something in your head that's been hard to turn into something real, I can help you take the next step.",
    tags: [
      "Design",
      "Development",
      "AI",
  ...
  },
  {
    ...
    services:
      "AI Development, Voice Modeling, Brand Identity, Web Development, UIUX",
    date: "Late 2024 - 2025",
    client: "IOOKI Labs",
    agency: "Independent",
    link: "https://iooki.io",
...

  {
    ...
    notes:
      "Personal art project exploring what I could create while in transit on my daily train rides with just an iPad and a pencil.",
  },
...

  {
    ...
    notes:
      "I am a committee member for the Darlington Arts Festival, and I am responsible for the design of the festival's print materials. I am also a consultant for the festival where I'm responsible for helping artists design their festival materials.",
  },
  {
    ...
    notes:
      "This one is a blast from the past when bands made websites to release their albums. I worked for a number of bands back in the day, but working for the Raveonettes was a memorable experience. I am a big fan of their music, and I was lucky enough to work with them on a project that would help them promote their music. And full disclaimer, I have no affiliation with the current site.",
  },
  // {
  //   label: "STEAM",
  //   year: "2023",
...

  {
    ...
    agency: "QUESO",
    notes:
      "This was a project I worked on for a client who was looking to create a new concept for a dim sum restaurant. The concept was to create something that was a new elegant take on the classic dim sum experience.",
  },
  {
    ...
    notes:
      "I really enjoyed working on this project. Working with the team to create an in-store display that was both functional and aesthetically pleasing for such an iconic wine estate was a dream gig.",
  },
  // {
  //   label: "Pellar",
  //   year: "2024",
